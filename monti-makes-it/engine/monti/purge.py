...
ORPHAN_CHECKS = [
    ...
    ("decision_items", "customer_id", "customers"),
    ("item_strategies", "item_id", "decision_items"),
    ("item_levers", "item_id", "decision_items"),
    ("item_revisions", "item_id", "catalog_items"),
    ("golden_samples", "item_id", "catalog_items"),
    ("quality_checks", "item_id", "catalog_items"),
    ("item_claims", "customer_id", "customers"),
    ("item_runs", "customer_id", "customers"),
    ("capacity_ledger", "customer_id", "customers"),
    ("factory_plans", "customer_id", "customers"),
    ("commitments", "customer_id", "customers"),
    ("performance_credits", "customer_id", "customers"),
    ("sample_boxes", "customer_id", "customers"),
    ("sample_events", "box_id", "sample_boxes"),
