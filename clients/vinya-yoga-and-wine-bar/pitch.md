# Vinya Yoga and Wine Bar — pitch sheet

**Current site:** https://www.vinyasd.com/
...
_Not claimed, because a page scan cannot prove them — check yourself if you want to use them: address + directions, services and pricing, reviews on the page._
