...
module.exports = [
  ...
  { key: 'hours',       label: 'Hours listed',                gap: 'Hours are missing or out of date',                                          fixed: 'Hours listed on-page and marked up for Google' },
  { key: 'address',     label: 'Address + directions',        gap: 'No address or one-tap directions',                                          fixed: 'Address with a one-tap Google Maps link' },
  { key: 'services',    label: 'Services and pricing',        gap: 'Services are vague and no pricing is shown, so people call competitors',     fixed: 'Every service listed with a starting price' },
  { key: 'reviews',     label: 'Reviews on the page',         gap: 'Your good reviews are stuck on Yelp instead of on your own site',           fixed: 'Best reviews pulled onto the homepage' },
  { key: 'cta',         label: 'Clear call to action',        gap: 'No obvious next step — visitors land and leave',                            fixed: 'One clear action above the fold on every screen size' },
