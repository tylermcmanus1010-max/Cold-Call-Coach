...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* an address or a set of hours reads fine in caps; an email address does
     not — IMPRESSIONDENTALGROUP@YAHOO.COM is a wall. It keeps its own case. */
  .spec dd a[href^="mailto:"]{text-transform:none;letter-spacing:.02em}
