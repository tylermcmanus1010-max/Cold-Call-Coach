...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* trust strip */
  .trust{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:2px;background:var(--line);border:1px solid var(--line);border-radius:var(--radius);overflow:hidden;margin-top:44px}
  .trust div{background:#fff;padding:20px}
